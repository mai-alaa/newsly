          ...
          child: SingleChildScrollView(
            child: Form(
              ...
              child: Padding(
                ...
                //   mainAxisAlignment: MainAxisAlignment.center,
                //   children: [
                //     Text('Already have an account?',style: Styles.poppinsReg16(context).copyWith(color: Colors.grey),),
                //     TextButton(onPressed: (){
                           
                //     }, child: Text('Log In',style: Styles.poppinsReg16(context).copyWith(color: kPrimaryColor),) )
                //   ],
                // )
