                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: const LabelFeiled(text: 'Your Name'),
                      ),
                      10.toHeight,
                      ...
                      Align(
                        alignment: Alignment.centerLeft,
                        child: const LabelFeiled(text: 'Email Address'),
                      ),
                      10.toHeight,
                      CustomTextFormFeiled(
                      ...
                      Align(
                        alignment: Alignment.centerLeft,
                        child: const LabelFeiled(text: 'Password'),
                      ),
                      10.toHeight,
                      BlocBuilder<PasswordCasesCubit, PasswordCasesStates>(
                        builder: (context, state) {
                          ...
                          return CustomTextFormFeiled(
                            ...
                            prefix: Icons.lock,
                            suffix: cubit.suffix,
                            suffixOnPressed: () => cubit.passwordVisibility(),
